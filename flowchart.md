...
flowchart LR
    ...
    K["<span style='color:black;'>State Management</span>"] --> K1["<span style='color:black;'>Component based</span>"]
    ...
    L["<span style='color:black;'>API Design</span>"] --> L1["<span style='color:black;'>Serverless Functions</span>"]
    ...
    M["<span style='color:black;'>Google</span>"] --> M1["<span style='color:black;'>NextAuth.js Authentication</span>"]
    M --> M2["<span style='color:black;'>SEO</span>"]
    M --> M3["<span style='color:black;'>Analytics</span>"]

    N["<span style='color:black;'>Optimization</span>"] --> N1["<span style='color:black;'>Server-side Caching</span>"]
    N --> N2["<span style='color:black;'>Lazy loading</span>"]
    N --> N3["<span style='color:black;'>Placeholder images</span>"]

    O["<span style='color:black;'>Error handling</span>"]

    P["<span style='color:black;'>Hot swapping virtual DOMS</span>"]
    Q["<span style='color:black;'>Testing</span>"]

    R["<span style='color:black;'>Microfrontends</span>"] --> R1["<span style='color:black;'>React.forwardRef</span>"]
    R --> R2["<span style='color:black;'>Multi Zones</span>"]
    R --> R3["<span style='color:black;'>Turborepo</span>"]

    S["<span style='color:black;'>3rd Party Libraries</span>"]
